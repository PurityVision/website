...
const Footer = (): JSX.Element => {
  return (
    <div className='bg-blue-100/50 p-8'>
      <div className='flex flex-col gap-4 md:flex-row mx-auto max-w-2xl justify-between'>
        ...
        <div className='flex flex-col justify-end'>
          <span className='text-sm text-gray-700 '>
            built by <Link href='https://twitter.com/greybonez' target='_blank' className='text-blue-400 border-transparent hover:text-green-400 transition-all border-b-2 hover:border-green-400'>@greybonez</Link>
          </span>
        </div>
